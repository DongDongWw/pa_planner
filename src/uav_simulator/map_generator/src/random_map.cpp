...
double _z_limit, _sensing_range, _resolution, _update_rate, _init_x, _init_y;
double _min_dist;
...
int main(int argc, char** argv) {
  ...
  n.param("ObstacleShape/lower_hei", _h_l, 6.0);
  ...
  n.param("update_rate", _update_rate, 10.0);
  ...
  ros::Rate loop_rate(_update_rate);
